    ...
    <div class="about">
        ...
        <div class="recentWorks">
            ...
            <div class="works">
                <div class="work">
                    <h2>Space Cowboy</h2>
                    <a href="template-single.html"><img src="<?php echo bloginfo('template_url'); ?>/dist/img/photos/preview/spaceKitty.png"/></a>
                    <p>A cat from Philadelphia's Kawaii Kitty Cafe. This cat gives some sort of cowboy vibe to me. Why space? ...</p>
                </div>
                <div class="work">
                    <h2>Napping Kitty</h2>
                    <a href="template-single.html"><img src="<?php echo bloginfo('template_url'); ?>/dist/img/photos/preview/nappingKitty.png"/></a>
