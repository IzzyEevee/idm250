...
function my_nav_wrap() {
  ...
  // the static link 
  $wrap .= '<li><div class="searchContainer"> <form action="/idm250/"> <input type="text" placeholder="Search..." name="s" ><button type="submit"><i class="fa fa-search"></i></button></form></div></li>';
